...
Static Function ModelDef()
	...
	oStrSC5:AddField( 'Total Bruto'    , 'Total Bruto'    , 'C5_XVLRBRT' , 'N', 16, 2, , , {}, .F.,{ | oModSC5 | CalcVlrBrt( oModSC5 ) } , .F., .F., .T., , )
	oStrSC5:AddField( 'Total Desconto' , 'Total Desconto' , 'C5_XVLRDSC' , 'N', 16, 2, , , {}, .F.,{ | oModSC5 | CalcVlrDsc( oModSC5 ) } , .F., .F., .T., , )
	oStrSC5:AddField( 'Total Líquido'  , 'Total Líquido'  , 'C5_XVLRLIQ' , 'N', 16, 2, , , {}, .F.,{ | oModSC5 | CalcVlrBrt( oModSC5 ) - CalcVlrDsc( oModSC5 ) } , .F., .F., .T., , )
...
Inicializador Padrão do Campo Virtual C5_XVLRBRT com o Total Bruto do Pedido 
@author Elton Teodoro Alves
@since 20/07/2017
@version 12.1.017
...
/*/
Static Function CalcVlrBrt( oModSC5 )
