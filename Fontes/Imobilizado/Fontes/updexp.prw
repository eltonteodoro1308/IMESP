...
aAdd( aSX6, { ;
	...
	'IO_XGRAM1'																, ; //X6_VAR
	'C'																		, ; //X6_TIPO
	'AMORTIZACAO ESTUDOS PROJETOS E DETALHAMENTOS'							, ; //X6_DESCRIC
	'AMORTIZACAO ESTUDOS PROJETOS E DETALHAMENTOS'							, ; //X6_DSCSPA
	'AMORTIZACAO ESTUDOS PROJETOS E DETALHAMENTOS'							, ; //X6_DSCENG
	''																		, ; //X6_DESC1
	''																		, ; //X6_DSCSPA1
	''																		, ; //X6_DSCENG1
	''																		, ; //X6_DESC2
...
aAdd( aSX6, { ;
	...
	'IO_XGRCA2'																, ; //X6_VAR
	'C'																		, ; //X6_TIPO
	'SOFTWARE - 24 MESES'													, ; //X6_DESCRIC
	'SOFTWARE - 24 MESES'													, ; //X6_DSCSPA
	'SOFTWARE - 24 MESES'													, ; //X6_DSCENG
	''																		, ; //X6_DESC1
	''																		, ; //X6_DSCSPA1
	''																		, ; //X6_DSCENG1
	''																		, ; //X6_DESC2
...
aAdd( aSX6, { ;
	...
	'IO_XGRCA3'																, ; //X6_VAR
	'C'																		, ; //X6_TIPO
	'SOFTWARE - JUCESP'														, ; //X6_DESCRIC
	'SOFTWARE - JUCESP'														, ; //X6_DSCSPA
	'SOFTWARE - JUCESP'														, ; //X6_DSCENG
	''																		, ; //X6_DESC1
	''																		, ; //X6_DSCSPA1
	''																		, ; //X6_DSCENG1
	''																		, ; //X6_DESC2
...
aAdd( aSX6, { ;
	...
	'IO_XGRCU1'																, ; //X6_VAR
	'C'																		, ; //X6_TIPO
	'MARCAS E PATENTES'														, ; //X6_DESCRIC
	'MARCAS E PATENTES'														, ; //X6_DSCSPA
	'MARCAS E PATENTES'														, ; //X6_DSCENG
	''																		, ; //X6_DESC1
	''																		, ; //X6_DSCSPA1
	''																		, ; //X6_DSCENG1
	''																		, ; //X6_DESC2
...
aAdd( aSX6, { ;
	...
	'IO_XGRCU2'																, ; //X6_VAR
	'C'																		, ; //X6_TIPO
	'DIREITO DE USO DE TELEFONE'											, ; //X6_DESCRIC
	'DIREITO DE USO DE TELEFONE'											, ; //X6_DSCSPA
	'DIREITO DE USO DE TELEFONE'											, ; //X6_DSCENG
	''																		, ; //X6_DESC1
	''																		, ; //X6_DSCSPA1
	''																		, ; //X6_DSCENG1
	''																		, ; //X6_DESC2
...
aAdd( aSX6, { ;
	...
	'IO_XGRCU6'																, ; //X6_VAR
	'C'																		, ; //X6_TIPO
	'ADIANT.P/IMPLANTAÇAO DE SOFTWARE'										, ; //X6_DESCRIC
	'ADIANT.P/IMPLANTAÇAO DE SOFTWARE'										, ; //X6_DSCSPA
	'ADIANT.P/IMPLANTAÇAO DE SOFTWARE'										, ; //X6_DSCENG
	''																		, ; //X6_DESC1
	''																		, ; //X6_DSCSPA1
	''																		, ; //X6_DSCENG1
	''																		, ; //X6_DESC2
...
aAdd( aSX6, { ;
	...
	'IO_XGRDI1'																, ; //X6_VAR
	'C'																		, ; //X6_TIPO
	'ESTUDOS PROJETOS E DETALHAMENTOS'										, ; //X6_DESCRIC
	'ESTUDOS PROJETOS E DETALHAMENTOS'										, ; //X6_DSCSPA
	'ESTUDOS PROJETOS E DETALHAMENTOS'										, ; //X6_DSCENG
	''																		, ; //X6_DESC1
	''																		, ; //X6_DSCSPA1
	''																		, ; //X6_DSCENG1
	''																		, ; //X6_DESC2
