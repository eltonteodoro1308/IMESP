...
Static Function ReportDef()
	...
	Local oSection1
	Local oSection2
	oReport := TReport():New("MATR025","Relacao das Sugestoes de Orcamentos","MTR025",;
	{|oReport| PrintReport(oReport)},;
	"Este relatorio ira imprimir a relacao das Sugestoes de Venda conforme os parametros solicitados.")
	...
	TRPosition():New(oSection1,"SB1",1,{|| xFilial("SB1") + SBG->BG_PRODUTO})
	...
	TRPosition():New(oSection2,"SB1",1,{|| xFilial("SB1") + SBH->BH_CODCOMP})
...
Static Function PrintReport(oReport)
	...
	SBG->BG_PRODUTO >= MV_PAR01 .And. ;	SBG->BG_PRODUTO <= MV_PAR02 )
