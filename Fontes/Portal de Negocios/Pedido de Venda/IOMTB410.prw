...
/*/
User Function IOMTB410( cXml, cError, cWarning, cParams, oFwEai )
				...
				If ! Empty( cSistem ) .And. ! Empty( cVendaId ) .And. aScan( aCabec, { |X| X[1] == 'C5_NUM'} ) == 0
					...
					Else
						...
						If nOper == 5
							...
							Return Retorno( 'F', 'Sistama/Pedido de Venda ' + Alltrim( cSistem ) + '/' + AllTrim( cVendaId ) + ' Não Localizado.', oFwEai )
